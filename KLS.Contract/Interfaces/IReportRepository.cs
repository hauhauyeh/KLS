...
namespace KLS.Contract.Interfaces
{
    public interface IReportRepository : IRepository<RptPOView>
    {
        ...
        IQueryable<RptBasicItemRow> BasicItem();
        ...
        IQueryable<RptInventoryAuditRow> InventoryAudit(InventoryAuditReportRequest req);
        ...
        IQueryable<RptMarketOrder> MarketOrder(ReportRequest reportReq);
    }
}
