-- =============================================================================
-- DropShipment_ConvertPOToBill -- LIVE BASELINE captured 2026-07-05 (frozen rollback ref).
-- Sole rollback artifact for the Phase B purchase-side base-qty change. Do not edit.
