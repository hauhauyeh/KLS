-- =============================================================================
-- VendorPayment_InsertPayNow -- LIVE BASELINE captured 2026-07-05 (frozen rollback ref).
-- Sole rollback artifact for the Phase B base-qty change. Do not edit.
...
DROP PROCEDURE IF EXISTS [dbo].[VendorPayment_InsertPayNow]
GO
