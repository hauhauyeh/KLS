-- =============================================================================
-- Purchase_Insert -- LIVE BASELINE captured 2026-07-05 (frozen rollback ref).
-- Sole rollback artifact for the Phase B Section-8 base-qty change. Do not edit.
...
DROP PROCEDURE IF EXISTS [dbo].[Purchase_Insert]
GO
