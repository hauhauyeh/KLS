...
BEGIN
    ...
    -- 2026-08-28: Deleted temp rows must not preserve permanent quote detail rows.
    DELETE sqd
    ...
    WHERE sqd.SalesQuoteId = @SalesQuoteId
      ...
      (
          ...
          WHERE t.EmpId = @EmpId
            ...
            AND t.LineId = sqd.SalesQuoteDetailId
            AND ISNULL(t.IsStrike, 0) = 0
            AND ISNULL(t.ChangeStatus, '') <> 'D'
      );
