...
-- 2026-06-25: deploy header brought to current standard -- DROP IF EXISTS replaces the
-- retired _prev rename (retired 2026-05-22; rollback ref is the dated _live_baseline.sql).
