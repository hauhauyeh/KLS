/*
    Purchase_GetAllList_live_baseline.sql
    Captured 2026-05-23 from dev (COGENT-2024\SQLEXPRESS / KLS_2026).
    Frozen snapshot before the Recent-filter ORDER BY change.
...
BEGIN
    ...
    BEGIN
        IF @Search IS NOT NULL
            SET @Qry += ' ORDER BY p.EnterDate DESC,p.ArrivalDate DESC';
        ELSE
