-- =============================================================================
-- TempSales_AddLine -- LIVE body captured 2026-07-06. REFERENCE ONLY (evidence).
-- This vertical does NOT modify AddLine. It is included to PROVE that AddLine's
-- return shape = TempSales_GetList's shape: the body ends with
--   EXEC [TempSales_GetList] @EmpId,@PayeeId,@SalesId,null,null,@NewTempSalesId
-- so adding MultipleToBase to TempSales_GetList covers the AddLine FromSqlRaw path.
-- (The repo's KLS/SQL/2026-04-30/TempSales_AddLine.sql is STALE -- do not use.)
-- =============================================================================
-- =============================================
-- TempSales_AddLine
