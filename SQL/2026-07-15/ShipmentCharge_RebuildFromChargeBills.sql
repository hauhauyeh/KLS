...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Charge-bill save rebuilt the shipment-wide source charges. For a single normal
        -- source bill, rerun the existing landed-cost allocation now that the charge exists.
        EXEC dbo.ShipmentCharge_RefreshSingleBillAllocation @ShipmentId = @ShipmentId;
    END TRY
    BEGIN CATCH
