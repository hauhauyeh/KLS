...
BEGIN
    ...
    /*
        ...
        The previous live version only accepted CategoryId.
        The current backend now passes Zone and PayeeId too, so the
        stored procedure must support the broader inventory report contract.
    ...
    */
    ...
    WHERE i.IsDeleted = 0
      ...
      /*
          ...
          The old live procedure had no Zone or Payee filter support.
          The newer report contract needs both filters.
      */
