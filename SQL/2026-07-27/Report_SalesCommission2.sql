...
BEGIN
    ...
    FilteredSales AS (
        SELECT s.SalesId, s.SalesNumber, s.SalesDocNumber, s.ShipDate, s.ShipId, s.SalesRepId, s.SalesTotal, s.DiscountApplied,
    ...
    INSERT INTO @SalesMargin(SalesNumber, SalesDocNumber, ShipId, ShipDate, SalesRepId, SalesTotal, CountableTotal, CostTotal)
    SELECT
        s.SalesNumber,
        s.SalesDocNumber,
        s.ShipId,
    ...
    GROUP BY s.SalesId, s.SalesNumber, s.SalesDocNumber, s.ShipId, s.ShipDate, s.SalesRepId, s.SalesTotal;
