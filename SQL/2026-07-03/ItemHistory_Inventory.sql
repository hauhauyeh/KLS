-- =============================================================================
-- ItemHistory_Inventory -- deploy (DROP + CREATE). Working file per SP workflow.
...
-- Baseline: KLS/SQL/2026-07-03/ItemHistory_Inventory_live_baseline.sql
-- =============================================================================
SET ANSI_NULLS ON
GO
...
DROP PROCEDURE IF EXISTS [dbo].[ItemHistory_Inventory]
GO

CREATE PROCEDURE [dbo].[ItemHistory_Inventory] -- EXEC ItemHistory_Inventory @ItemId=1377
    @ItemId INT
AS
BEGIN
    SET NOCOUNT ON;
