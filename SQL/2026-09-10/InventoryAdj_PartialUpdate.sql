...
BEGIN
	...
	-- Guard required entered values before writing adjustment source and journal rows.
	-- Qty-only keeps price optional; value-bearing adjustments must carry price.
	IF @AdjType <> 'C'
	BEGIN
		IF NOT EXISTS (
			SELECT 1
