...
CREATE OR ALTER PROCEDURE [dbo].[Deposit_ExportDetail] -- EXEC dbo.Deposit_ExportDetail @Search=NULL, @StartDate=NULL, @EndDate=NULL, @ToAccountId=NULL, @Filterby=NULL, @SortField=NULL, @SortOrder=NULL, @Uncleared=0
...
BEGIN
    ...
    SELECT
        ...
        S.SalesDocNumber AS SalesDocNum,
