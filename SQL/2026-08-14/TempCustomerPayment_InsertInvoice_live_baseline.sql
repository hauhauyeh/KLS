-- 2026-08-13 DROP-SHIP-OPEN-INVOICE-GUARD: require posted Sales journal for positive direct invoice add.
CREATE   PROCEDURE [dbo].[TempCustomerPayment_InsertInvoice] -- EXEC dbo.TempCustomerPayment_InsertInvoice @EmpId=1,@CustomerPaymentId=0,@SalesNumber=100000,@TempId=0
