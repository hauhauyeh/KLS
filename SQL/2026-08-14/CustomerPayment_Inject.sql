...
CREATE OR ALTER PROCEDURE [dbo].[CustomerPayment_Inject] -- EXEC dbo.CustomerPayment_Inject @EmpId=1,@PayeeId=1,@CustomerPaymentId=0,@PaymentType=N'Customer Payment',@AllowFutureInvoices=0
