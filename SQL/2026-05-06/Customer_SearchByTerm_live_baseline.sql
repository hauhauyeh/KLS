-- Live baseline of dbo.Customer_SearchByTerm BEFORE the invoice-search feature.
-- Captured 2026-05-06. Use as rollback reference.

CREATE PROCEDURE [dbo].[Customer_SearchByTerm] --[Customer_SearchByTerm] 'a',0,null,0,0
