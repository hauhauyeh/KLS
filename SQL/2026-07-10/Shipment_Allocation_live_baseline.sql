...
BEGIN
    ...
    BEGIN TRY
        ...
        -- intentionally left WITHOUT the all-or-nothing completeness guard for now (Plan 1 -º9 open
        ...
        ;WITH ShipTotals AS (
            SELECT
                ...
                -- the charge is allocated over, so multi-bill shipments are correct GÇö a sibling bill's
