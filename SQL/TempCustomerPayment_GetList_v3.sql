IF OBJECT_ID('dbo.TempCustomerPayment_GetList_prev', 'P') IS NOT NULL
    DROP PROCEDURE dbo.TempCustomerPayment_GetList_prev;

EXEC sp_rename 'dbo.TempCustomerPayment_GetList', 'TempCustomerPayment_GetList_prev';
GO

CREATE PROCEDURE [dbo].[TempCustomerPayment_GetList]
