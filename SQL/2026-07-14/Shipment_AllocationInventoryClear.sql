...
BEGIN
    ...
    -- 2026-07-13 DROPSHIP-EXCLUDE: drop-ship bills have no inventory receipt to capitalize landed
    -- cost into; posting is document-level COGS. No inventory clear should run.
    IF @IsDropShip = 1
        RETURN;
