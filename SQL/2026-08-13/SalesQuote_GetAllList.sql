...
-- 2026-08-13: sales-role users see only quotes for their assigned customers, matching Sales_GetAllList.
-- 2026-08-11: return SalesQuoteType for Sales Quote type CRUD.
-- ============================================
CREATE OR ALTER PROCEDURE [dbo].[SalesQuote_GetAllList]
    @Pageno         INT,
    @Pagesize       INT,
    @Search         NVARCHAR(100),
    @StartDate      DATE,
...
BEGIN
    ...
    INNER JOIN dbo.SystemRole r ON u.SystemRoleId = r.SystemRoleId
    WHERE u.PayeeId = @EmpId;
    ...
    SET @Qry += '
        ...
        LEFT JOIN Customer c ON c.PayeeId = sq.PayeeId
