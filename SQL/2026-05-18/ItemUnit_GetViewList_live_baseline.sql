-- ============================================================================
-- LIVE BASELINE — captured 2026-05-18 before alt-unit ordering change
-- Source: SELECT OBJECT_DEFINITION(OBJECT_ID('dbo.ItemUnit_GetViewList'))
-- Purpose: rollback reference for the alt-unit ordering round.
-- ============================================================================
