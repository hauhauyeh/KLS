...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            JOIN   dbo.Item i ON pd.ItemId = i.ItemId
            WHERE  pd.PurchaseId = @PurchaseId
              -- 2026-08-02 PHYSICAL_LANDED_COST: landed cost belongs to physical item lines.
              -- Inventory vs COGS routing is handled by Shipment_AllocationInventoryClear.
              AND  pd.ItemId IS NOT NULL;
        ...
        JOIN   dbo.Item i ON pd.ItemId = i.ItemId
        WHERE  pd.ItemId IS NOT NULL; -- PHYSICAL_LANDED_COST: include inventory and non-inventory physical items.
