...
-- 2026-07-21 (CRM Phase 4): add LastActivityAt so the lead list is
--   action-oriented (Last Activity / Next Follow-Up columns).
-- ============================================================
...
BEGIN
    ...
    SELECT
        ...
        L.EstimatedValue,
        (SELECT MAX(A.ActivityDate) FROM CRMActivity A WHERE A.LeadId = L.LeadId) AS LastActivityAt,
