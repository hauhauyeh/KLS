...
-- 2026-08-13 DS-STAGE2-PO-ORDERED-GUARD: DS SO edit may rebuild linked PO detail only while linked PO StageId=1.
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF ISNULL(@ExistingPurchaseStageId, 0) <> 1
            BEGIN
                RAISERROR('Clear linked PO V-Doc#, Cont#, and Ship Qty before editing this drop-ship order.', 16, 1);
                RETURN;
            END
        END
    END
