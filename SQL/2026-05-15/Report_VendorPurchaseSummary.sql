/*
    ...
    2026-05-15 — Exclude vendor PayeeId 200680 from the report
                 (per Howard, single hardcoded exclusion).
...
CREATE OR ALTER PROCEDURE [dbo].[Report_VendorPurchaseSummary]
    @IncludeClosed BIT = 0
AS
BEGIN
    SET NOCOUNT ON;
    ...
    WHERE pay.PayeeType = 'V'
      ...
      AND pay.PayeeId <> 200680              -- 2026-05-15 hardcoded exclude (Howard's call)
    GROUP BY
        pay.PayeeId,
        pay.PayeeName
    ORDER BY
