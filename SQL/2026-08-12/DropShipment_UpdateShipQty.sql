...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 2026-08-12: mark the drop-ship PO as factory-progressed, then use the shared
        -- Transit helper so Sales follows the finalized 0/1 -> 2 rule.
        UPDATE Purchase SET
            StageId = 2,
        ...
        IF @@ROWCOUNT = 0
        BEGIN
            RAISERROR('Drop-ship purchase header was not updated for this ship-qty update.', 16, 1);
        END
