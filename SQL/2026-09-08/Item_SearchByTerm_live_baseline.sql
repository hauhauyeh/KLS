...
CREATE   PROCEDURE [dbo].[Item_SearchByTerm] -- EXEC dbo.Item_SearchByTerm @SearchTerm = N'1500''', @ShowInactive = 1, @ShowNonInventory = 1
...
BEGIN
    ...
    (
        ...
        WHERE i.ItemType IN ('Inventory', 'NonInventory')
          AND (@TermItemId IS NOT NULL OR @ShowNonInventory = 1 OR i.ItemType = 'Inventory')
