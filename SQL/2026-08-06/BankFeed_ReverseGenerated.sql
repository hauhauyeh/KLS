...
BEGIN
    ...
    BEGIN TRY
        ...
        -- charge) or, since Phase 2a, a Deposit. Anything else means another feature wrote
        -- this table and this procedure does not know how to undo it.
        -- 2026-08-06: was  WHERE SourceDocType <> 'VendorPayment'
        IF EXISTS (SELECT 1 FROM #Sources WHERE SourceDocType NOT IN ('VendorPayment', 'Deposit'))
