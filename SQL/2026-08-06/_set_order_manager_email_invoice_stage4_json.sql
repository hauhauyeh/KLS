-- Set Order Manager document/print menu JSON for Email Invoice stage 4.
-- This script is intentionally guarded for KLS_2026 local dev.
--
...
IF DB_NAME() <> 'KLS_2026'
BEGIN
    THROW 51000, 'This script is only intended for database KLS_2026.', 1;
END;
