...
CREATE PROCEDURE [dbo].[Report_APAging] -- EXEC Report_APAging @AsOfDate='2026-05-27',@AgeBasis='DueDate'
-- EXEC Report_APAging @AsOfDate='2026-05-27',@AgeBasis='InvoiceDate'
-- EXEC Report_APAging @AsOfDate='2026-05-27',@AgeBasis='DueDate',@VendorId=200166
-- EXEC Report_APAging @AsOfDate='2026-05-27',@AgeBasis='DueDate',@TermId=24
    @AsOfDate  DATE,
...
BEGIN
    ...
    */
    ...
    SELECT
        ...
        b.DueDate,
        t.TermName          AS Term,
        -- 2026-05-27: vendor's preferred payment method for the report's
        -- vendor-name chip. LEFT JOIN (not INNER) so an AP row with imperfect
        -- vendor master data still appears — the chip just renders blank.
    ...
    LEFT JOIN dbo.Vendor v ON v.PayeeId = b.PayeeId
    ORDER BY
        b.PayeeName,
