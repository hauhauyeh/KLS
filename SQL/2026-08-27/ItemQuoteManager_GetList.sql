...
BEGIN
    ...
    OwnRows AS (
        SELECT
            ...
            iu.RecentCost,
            iu.P1,
            -- 2026-08-27: expose scheduled MGP price plus PriceSheet 0 cost columns.
            -- These are passive output fields; current final-price logic stays unchanged.
            NewPrice = t.NewPrice,
            i.TCost1,
            i.TCost2,
            i.NCost1,
    ...
    AllRows AS (
        SELECT
            ...
            Unit, RecentCost, P1, NewPrice, TCost1, TCost2, NCost1, NCost2,
            BaseMarkup, IsBaseToRecentCost,
