...
-- 2026-08-01 DIRECT-COGS-AP: product @DSCC bridge is superseded for new drop-ship conversion.
--   Product cost posts purchase-side DR @COGS / CR @AP. Sales-side journal posts revenue only.
