...
CREATE   PROCEDURE [dbo].[Shipment_AssignBills]   -- EXEC dbo.Shipment_AssignBills @ShipmentId=55, @PurchaseIds='12345,12346'
    @ShipmentId  INT,
...
BEGIN
    ...
    BEGIN TRY
        BEGIN TRAN;
            ...
            DECLARE @Pid INT;
            -- 2026-07-13 DROPSHIP-EXCLUDE: allocate only NON-drop-ship bills. Drop-ship bills stay
            -- linked (inserted above) but receive no landed cost / inventory clear. Prior:
