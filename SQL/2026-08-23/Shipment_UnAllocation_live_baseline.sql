...
CREATE   PROCEDURE [dbo].[Shipment_UnAllocation] -- EXEC dbo.Shipment_UnAllocation @ShipmentPurchaseId=1
...
BEGIN
    ...
    -- 2026-07-15 UNASSIGN_DELETE_SEPARATION: do not delete generated shipment AP bills here.
    -- UI may run Shipment_Delete immediately after last-unassign; package delete belongs there.
    -- Prior behavior:
    -- IF EXISTS (
    --     SELECT 1 FROM dbo.Purchase p
    --     WHERE p.IsShipment = 1
