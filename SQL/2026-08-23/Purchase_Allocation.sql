...
CREATE OR ALTER PROCEDURE [dbo].[Purchase_Allocation] -- EXEC dbo.Purchase_Allocation @PurchaseId = 1, @RefreshVolume = 0
    @PurchaseId    INT,
    @RefreshVolume BIT = 0
AS
BEGIN
    ...
    BEGIN
        ...
        -- Allocation is provisional. Final AP charge bill generation belongs only to
        -- dbo.Shipment_ConfirmChargesComplete, not ordinary assignment/save/reallocation.
        --
        -- Prior behavior:
