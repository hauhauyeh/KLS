...
GO
-- KLS-4DP-InvAdjGAL-NewPrice-widen (2026-07-09): read SP #InvTable.NewPrice widened (18,2)->(18,4) so a 4dp
--   NewPrice (source InventoryAdjDetail.NewPrice is decimal(18,4)) is not truncated on read/display.
--   PriceBefore left (18,2): it is PrevCost/AverageCost (a cost), covered by the InventoryAdj costing carve-out.
...
BEGIN
    ...
    CREATE TABLE #InvTable (
        ...
        ItemId INT,
        NewQty DECIMAL(18,2),
        NewPrice DECIMAL(18,4),   -- 4dp: was (18,2) -- read truncated 4dp NewPrice
        ...
        PriceBefore DECIMAL(18,2)   -- cost (=PrevCost/AverageCost) -- stays 2dp per InventoryAdj costing carve-out
    );
