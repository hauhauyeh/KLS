...
GO
-- 2026-08-29 IsManualPrice pass-through (plan-reprice-open-orders-v1 slice 2): merged orders keep rep-priced lines flagged. Baseline: Sales_MergeOrder_live_baseline.sql
