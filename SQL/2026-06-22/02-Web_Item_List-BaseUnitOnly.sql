-- Add SystemSetting key (run once)
IF NOT EXISTS (SELECT 1 FROM SystemSetting WHERE SettingKey = 'WEB_SELL_BASEUNIT_ONLY')
    INSERT INTO SystemSetting (SettingKey, SettingValue, DataType) VALUES ('WEB_SELL_BASEUNIT_ONLY', 'false', 'bool');
GO
