-- ============================================================================
-- LIVE BASELINE — captured 2026-05-17 before vendor-mode addition
-- Source: SELECT OBJECT_DEFINITION(OBJECT_ID('dbo.Item_ListActiveForKeybox'))
-- Purpose: rollback reference for the @Mode = 'vendor' round
-- ============================================================================
