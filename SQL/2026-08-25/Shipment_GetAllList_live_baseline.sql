...
CREATE   PROCEDURE [dbo].[Shipment_GetAllList] -- EXEC dbo.Shipment_GetAllList @Pageno = 1, @Pagesize = 50, @Search = NULL, @StartDate = NULL, @EndDate = NULL, @PayeeId = NULL, @Filterby = 'open', @SortField = NULL, @SortOrder = NULL, @IsCount = 0, @TotalCount = NULL
	@Pageno int,
	@Pagesize int,
	@Search nvarchar(50),
	@StartDate date,
...
BEGIN
	...
	IF @OrderBy IS NOT NULL
		SET @Qry += ' ORDER BY ' + @OrderBy + ' ' + @Direction + ', s.ShipmentId ASC'
