-- Fix: Replace Closed guard with IsLocked guard + add cursor for remaining purchases
IF OBJECT_ID('dbo.Shipment_UnAllocation_prev') IS NULL
    EXEC sp_rename 'Shipment_UnAllocation', 'Shipment_UnAllocation_prev';
GO

CREATE PROCEDURE [dbo].[Shipment_UnAllocation]
