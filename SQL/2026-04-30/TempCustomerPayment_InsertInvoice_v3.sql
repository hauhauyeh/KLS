IF OBJECT_ID('dbo.TempCustomerPayment_InsertInvoice_prev', 'P') IS NOT NULL
    DROP PROCEDURE dbo.TempCustomerPayment_InsertInvoice_prev;

EXEC sp_rename 'dbo.TempCustomerPayment_InsertInvoice', 'TempCustomerPayment_InsertInvoice_prev';
GO

CREATE PROCEDURE [dbo].[TempCustomerPayment_InsertInvoice]
