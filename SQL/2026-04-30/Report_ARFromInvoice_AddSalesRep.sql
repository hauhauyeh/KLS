...
-- Add sales rep filter support to AR Invoice report.

DROP PROCEDURE IF EXISTS [dbo].[Report_ARFromInvoice_prev];
GO

EXEC sp_rename 'Report_ARFromInvoice', 'Report_ARFromInvoice_prev';
GO
