        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    -- 2026-07-08 recovery basis fix.  OLD: @RecoveredQty * @Price
                    SET @ActualValue =
                        @RecoveredQty * @UnitCostBase;
                ...
                BEGIN
                    ...
                    -- 2026-07-08 recovery basis fix.  OLD: (@Price - @LAvgCost)
                    SET @COGSAdjAmount =
                        ROUND(ABS(@Qty) * (@UnitCostBase - @LAvgCost), 6) * -1;
                END
                ELSE IF @Qty = 0
                BEGIN
